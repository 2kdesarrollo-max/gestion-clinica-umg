...
PROMPT Nota: DBMS_STATS modifica estadisticas del optimizador (metadata).
BEGIN
...
PROMPT 5) Limpieza: eliminar indices de demo (si existen)
BEGIN
  EXECUTE IMMEDIATE 'DROP INDEX SUPERADMIN.IDX_RESERVAS_ESTADO_FECHA';
EXCEPTION
  WHEN OTHERS THEN
...
BEGIN
  EXECUTE IMMEDIATE 'DROP INDEX SUPERADMIN.IDX_PACIENTES_EMAIL_UPPER';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE <> -1418 THEN RAISE; END IF;
END;

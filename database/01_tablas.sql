...
-- BLOQUEOS / MANTENIMIENTOS DE QUIRÓFANOS
CREATE TABLE QUIROFANO_BLOQUEOS (
  id_bloqueo        NUMBER PRIMARY KEY,
  id_quirofano      NUMBER REFERENCES QUIROFANOS(id_quirofano),
  tipo              VARCHAR2(20) DEFAULT 'MANTENIMIENTO'
                    CHECK (tipo IN ('MANTENIMIENTO','BLOQUEO')),
...
CREATE SEQUENCE SEQ_QUIROFANO_BLOQUEOS START WITH 1 INCREMENT BY 1;
